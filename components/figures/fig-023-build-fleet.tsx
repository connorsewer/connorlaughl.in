 ...
 * three ranks by where they run. Six on the employer stack, one in the open,
 ...
 * (The open shelf held two until hermes-agent was cut, 2026-08-06. The
 * employer shelf went from five to six when the TSI LLM wiki card landed,
 * 2026-08-19.)
 */
...
export function Fig023BuildFleet({ showSubjectRail }: PlateProps = {}) {
  ...
  return (
    <Figure
      ...
      num={23}
      title="Build fleet"
      groundTruth="The nine systems the builds section lists, one box per card in card order: six running on the employer's marketing stack, one published in the open, and two in the operator's own toolchain, ending with the site this figure renders on."
