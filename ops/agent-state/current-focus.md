...
Shared cross-session snapshot of the most important active work right now.

## Update rules

- Keep this short
- Prefer current priorities over exhaustive history
- Update when the main focus changes materially
- Read this before long-running delegated or scheduled work when continuity matters
