...
export const tocSections: CoverTocSection[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        href: "/case-studies/governed-llm-wiki",
        countKey: "case-studies/governed-llm-wiki",
        dek: "A knowledge base compiled once from the company's sources, with an approval tier on every page people and agents read.",
      },
      {
        num: "04",
