...
## Overview
Design and deployment of a 90-day, budget-light BDR (Business Development Representative) program repurposing two telesales reps into a focused lead generation pod targeting website signals and ABM outreach.

## Key Metrics
- **40-60** first meetings target (90 days)
- **12-20** SQLs target (90 days)
- **3-5** weekly meetings per BDR
...
- **Outbound Messaging Kits**:
  - DebtNext → ARM cross-sell email template
  - Healthcare RCM denials automation template
  - Digital/AI collections enterprise template
  - 30-second call opener script
  - 11-14 second voicemail script
  - 5-touch sequence framework (10 business days)

- **Operational Infrastructure**:
  - Salesforce field requirements (Intent Tier, Last Sequence Day)
  - Lead routing logic by vertical
  - Discovery Brief template for AE handoffs
  - Compliance brief (call windows, DNC, opt-outs)
  - QA schedule (Tue/Thu live-listen + email review)

- **Week-1 Task List** (10 implementation steps)

## What TSI Marketed
- **"DebtNext → ARM Cross-Sell"** - Fastest warm path to revenue
- **"Digital/AI Collections"** - Up to 15% productivity lift
- **"Healthcare Denials Automation"** - PULSE/SAGA pilots
- **"Website Signal Response"** - Real-time intent-based outreach
