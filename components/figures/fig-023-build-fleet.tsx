 ...
 * FIG_023 [ BUILD FLEET ]
 *
 * Ground truth: the nine systems the `/builds` section lists, standing in
 * three ranks by where they run. Five on the employer stack, two in the open,
...
export function Fig023BuildFleet({ showSubjectRail }: PlateProps = {}) {
  ...
  return (
    <Figure
      ...
      num={23}
      title="Build fleet"
      groundTruth="The nine systems the builds section lists, one box per card in card order: five running on the employer's marketing stack, two published in the open, and two in the operator's own toolchain, ending with the site this figure renders on."
      caption="The fleet, mustered: the employer stack, the open-source pair, and the operator's own toolchain, with the page you are reading standing last."
